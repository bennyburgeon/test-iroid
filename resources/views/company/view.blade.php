            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a href="{{ route('admin.company.create') }}" class="btn btn-primary float-right"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="info-box bg-light">
                                                    <div class="info-box-content">
                                                        <img src="../image/company/{{ $brn->logo }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                Created At:</br>
                                                {{ Timezone::convertToLocal($brn->created_at) }}
                                            </div>
                                            <div class="col-md-12">
                                        <div class="info-box-content">
                                            {{ $brn->description }}
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-md-6">
                                    <a href="{{ route('admin.company.edit', $brn->company_id) }}"
                                        class="btn btn-sm btn-primary">View/Edit</a>
                                        </div> -->
                                        <div class="col-md-6">
              <form method="POST" action="{{ route('admin.company.destroy',encrypt($brn->company_id)) }}">
                @csrf
